...
ndpFramework.controller('ItemsController',
    function($scope,
        $translate,
        $modal,
        $filter,
    ...
    $scope.model.horizontalMenus = [
        {id: 'result', title: 'results', order: 1, view: 'components/items/results.html', active: true, class: 'main-horizontal-menu'},
        {id: 'trafficLight', title: 'traffic_light', order: 2, view: 'components/items/traffic-light.html', class: 'main-horizontal-menu'},
        {id: 'budgetPerformance', title: 'budget_performance', order: 3, view: 'components/items/budget-performance.html', class: 'main-horizontal-menu'},
        {id: 'dashboard', title: 'dashboard', order: 6, view: 'components/items/dashboard.html', class: 'external-horizontal-menu'}
    ];
