...
var ndpPerformanceDataEntry = angular.module('ndpPerformanceDataEntry',
        ['ui.bootstrap', 
         'ngRoute', 
         'ngCookies',
         'ngSanitize',
         'ngMessages',
         'ndpPerformanceDataEntryServices',
         'ndpPerformanceDataEntryFilters',
         'ndpPerformanceDataEntryDirectives',
         'd2Directives',
         'd2Filters',
         'd2Services',
         'd2Controllers',
